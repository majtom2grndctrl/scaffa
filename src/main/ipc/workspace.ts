...
export function registerWorkspaceHandlers() {
  ...
  ipcMain.handle(
    ...
    validated(
      GetRecentWorkspacesRequestSchema,
      GetRecentWorkspacesResponseSchema,
      async (_event, _request: GetRecentWorkspacesRequest): Promise<GetRecentWorkspacesResponse> => {
  ...
  ipcMain.handle(
    ...
    validated(
      OpenRecentWorkspaceRequestSchema,
      OpenRecentWorkspaceResponseSchema,
      async (_event, request: OpenRecentWorkspaceRequest): Promise<OpenRecentWorkspaceResponse> => {
  ...
  ipcMain.handle(
    ...
    validated(
      OpenDemoWorkspaceRequestSchema,
      OpenDemoWorkspaceResponseSchema,
      async (_event, _request: OpenDemoWorkspaceRequest): Promise<OpenDemoWorkspaceResponse> => {
